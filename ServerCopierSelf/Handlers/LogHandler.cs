namespace ServerCopierSelf.Handlers
{
    ...
    public static class LogHandler
    {
        ...
        /// </param>
        public static void LogMessage(SocketCommandContext context, string error = null, LogSeverity logSeverity = LogSeverity.Info)
        {
        ...
        /// The severity of the message
        /// </param>
        public static Task LogMessage(string message, LogSeverity logSeverity = LogSeverity.Info)
        {
            switch (logSeverity)
            {
                case LogSeverity.Info:
        ...
        /// The config.
        /// </param>
        public static void PrintApplicationInformation(ConfigModel config)
        {
